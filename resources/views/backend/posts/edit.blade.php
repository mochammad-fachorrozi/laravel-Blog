                        ...
                        <div class="x_content">
                          ...
                          <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image', $post->image) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('image_description') is-invalid @enderror" name="image_description" value="{{ old('image_description', $post->image_description) }}" placeholder="Input Image Description" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $post->title) }}" placeholder="Input Title Post" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5" placeholder="Input Content Post" required>{{ old('content', $post->content) }}</textarea>
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <textarea type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords', $post->keywords) }}" placeholder="Input Keywords Post" required></textarea>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <textarea type="text" class="form-control @error('tags') is-invalid @enderror" name="tags" value="{{ old('tags', $post->tags) }}" placeholder="Input Tags Post" required></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control @error('message') is-invalid @enderror" name="message" value="{{ old('message', $post->message) }}" placeholder="Input message Post" rows="5" required></textarea>
                            ...
                            <div class="mt-4 d-flex justify-content-end">
                              ...
                              <a href="{{ route('posts.index') }}" type="button" class="btn btn-md btn-danger">CANCEL</a>
                            </div>
