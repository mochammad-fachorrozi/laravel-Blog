                    ...
                    <div class="col-md-12 col-sm-12 ">
                      <div class="x_panel">
                        <div class="x_title">
                          ...
                          <a href="{{ route('posts.index') }}" class="btn btn-success btn-md">Back</a>
                        ...
                        <div class="x_content">
                          ...
                          <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}" placeholder="Input Category Post" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords') }}" placeholder="Input Keywords Post" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tags') is-invalid @enderror" name="tags" value="{{ old('tags') }}" placeholder="Input Tags Post" required>
