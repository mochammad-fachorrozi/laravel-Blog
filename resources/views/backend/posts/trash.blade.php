                    ...
                    <div class="col-md-12 col-sm-12 ">
                      <div class="x_panel">
                        <div class="x_title">
                          ...
                          <a href="{{ route('posts.create') }}" class="btn btn-success btn-md"><i class="fa fa-plus" aria-hidden="true"></i> Add Post</a>
                          ...
                          <table id="datatable" class="table table-striped table-bordered text-center" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form onsubmit="return confirm('Move data to trash ?');" action="{{ route('posts.destroy', $post->id) }}" method="POST">
